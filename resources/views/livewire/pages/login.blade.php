        ...
        <div class="auth-container">
            ...
            <form wire:submit.prevent="login" class="auth-form">
                <div class="input-group">
                    <input type="text" wire:model="email" placeholder="Email Address" required>
                </div>
                <div class="input-group relative" x-data="{ show: false }">
                    <input :type="show ? 'text' : 'password'" wire:model="password" placeholder="Password" required class="w-full pr-10">
